...
//    var contact = Contact()
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let labelLastname = cell.viewWithTag(1001) as! UILabel
        labelLastname.text = arraycontact[indexPath.row].lastName

        return cell
    }

    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        let detailedContact = storyboard?.instantiateViewController(withIdentifier: "detailedContact") as! ViewController
        
    
        detailedContact.contact123 = arraycontact[indexPath.row]
    
        navigationController?.show(detailedContact, sender: self)
